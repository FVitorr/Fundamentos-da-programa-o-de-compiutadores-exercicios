...
int main(int argc, char** argv) {
    ...
    do {
        ...
        if (sexo == 'M') {
            ...
            scanf("%d", &idade);
            printf("Voce possui experiencia no servico (S. Sim | N. Nao): ");
            scanf(" %c", &experiencia);
    ...
    if (contF > 0) {
        ...
        printf("    Menor idade das mulheres com experiencia no serviço:  %d \n", menor_idade);
    ...
    if (contH_exp > 0) {
        printf("    Media de idade de homens com experiencia no servico: %.2f. \n", media_homem);
    } else {
        printf("    Nenhum canditato masculino com experiencia no servico. \n");
    }
    ...
    if (contF_menos21 > 0) {
        printf("    Quantidade de mulheres com menos de 21 anos com experiencia no servico: %d. \n", contF_exp);
    } else {
        printf("    Nenhum canditato feminino com menos de 21 anos e experiencia no servico. \n");
    }
