...
int main(int argc, char** argv) {
    ...
    int i, cont_barato = 0, cont_normal = 0, cont_caro = 0;

    float preco_unitario, preco_final, custo_estocagem, maior_preco = 1, menor_preco = 1, media_adcionais;
    float impostos, total_impostosN, total_impostosS, total_impostos, total_estocagemN = 0, total_estocagemS = 0;
    float total_estocagem, total_adcionais;
    ...
    for (i = 1; i <= 12; i++) {
        ...
        if (refrigeracao == 'N' || refrigeracao == 'n') {
            ...
            printf("Produto não necessista de refrigeracao. \n");
            ...
            printf("Digite o preco unítario do produto: ");
